...
class TestCopulaGenerateMixedCopula(unittest.TestCase):
    ...
    def test_ctg_init(self):
        ...
        ctg = copmix.CTGMixCop(cop_params, weights)
        ...
        self.assertIsInstance(ctg.copulas[0], coparc.Clayton)
        self.assertIsInstance(ctg.copulas[1], copeli.StudentCopula)
        self.assertIsInstance(ctg.copulas[2], coparc.Gumbel)
    ...
    def test_cfg_init(self):
        ...
        pd.testing.assert_series_equal(description, pd.Series(expected_descrb))
        self.assertIsInstance(cfg.copulas[0], coparc.Clayton)
        self.assertIsInstance(cfg.copulas[1], coparc.Frank)
        self.assertIsInstance(cfg.copulas[2], coparc.Gumbel)
    ...
    def test_plot_abs_class_method(self):
        ...
        theta = 5
        weights = (0.3, 0.4, 0.3)
        ctg = copmix.CTGMixCop(cop_params=(theta, rho, nu, theta), weights=weights)
