...
class TestBasicCopulaStrategy(unittest.TestCase):
    ...
    def test_cfgmixcop_fit(self):
        ...
        self.assertAlmostEqual(descr['Clayton theta'], 6.6258756, 3)
        self.assertAlmostEqual(descr['Frank theta'], 4.0003041, 3)
        self.assertAlmostEqual(descr['Gumbel theta'], 4.7874674, 3)
        self.assertAlmostEqual(descr['Clayton weight'], 0.503564, 3)
        self.assertAlmostEqual(descr['Frank weight'], 0.0, 3)
        self.assertAlmostEqual(descr['Gumbel weight'], 0.4964350, 3)
    ...
    def test_ctgmixcop_fit(self):
        ...
        self.assertAlmostEqual(descr['Clayton theta'], 2.1268764, 3)
        self.assertAlmostEqual(descr['Student rho'], 0.001, 3)
        self.assertAlmostEqual(descr['Student nu'], 4.00676, 3)
        self.assertAlmostEqual(descr['Gumbel theta'], 5, 3)
        self.assertAlmostEqual(descr['Clayton weight'], 1, 3)
        self.assertAlmostEqual(descr['Student weight'], 0, 3)
        self.assertAlmostEqual(descr['Gumbel weight'], 0, 3)
