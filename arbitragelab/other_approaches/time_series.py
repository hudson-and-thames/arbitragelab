...
"""
This module implements quantile time series approach described in
...
class QuantileTimeSeriesTradingStrategy:
    """
    The strategy which implements quantile-based time series approach in mean-reversion trading. First, we define
