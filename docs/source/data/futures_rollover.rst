...
Futures are a form of contract drawn up between two parties for the purchase or sale of a quantity
...
used heavily for speculative purposes. While futures were often utilised to hedge the prices
of agricultural or industrial goods, a futures contract can be formed on any tangible or
...
- Tick size refers to the smallest possible price movement and tick value is the loss or gain incurred by that movement.

So first of all, we have to ask, why there is a difference in the price in subsequent Futures contracts at all? 

To gain an understanding of this, one way is to follow the close link between
...
This is the typically done already by market data providers like Bloomberg. We will (possibly) end up in
...
will introduce a large drift to the prices. This can lead to negative data for sufficiently
...
adjust the prices of historical contracts. This allows a continous stream without an
