...
.. doctest::
    ...
    >>> plt.rcParams['figure.figsize'] = (24, 12) # doctest: +SKIP

    >>> # Loading data
    >>> data =  yf.download("CL=F NG=F", start="2015-01-01", end="2020-01-01")["Adj Close"] # doctest: +IGNORE_OUPUT
    ...
