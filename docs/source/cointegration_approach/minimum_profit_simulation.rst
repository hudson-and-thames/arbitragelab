...
.. raw:: html
    ...
    <button class="special" onclick="window.open('https://hudsonthames.org/an-introduction-to-cointegration/','_blank')">
      <span>Read our article I on the topic</span>
    </button>

    <button class="special" onclick="window.open('https://hudsonthames.org/caveats-in-calibrating-the-ou-process/','_blank')">
      <span>Read our article II on the topic</span>
    </button>
