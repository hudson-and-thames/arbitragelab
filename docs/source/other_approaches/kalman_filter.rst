...
While for truly cointegrating price series we can use the tools described in the Mean Reversion section
of this module (Johansen test, etc.), for other price series we should use other tools to estimate the
